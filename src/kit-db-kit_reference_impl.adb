...
package body Kit.Db.Kit_Reference_Impl is
   ...
   begin
      return Kit_Reference_Database_Record'Size / System.Storage_Unit;
   ...
   begin
      ...
      begin
         ...
         Item.Reference := Kit_Record_Reference (T);
      end;
   end Read;
   ...
   begin
      ...
      Marlowe.Key_Storage.To_Storage (Marlowe.Database_Index (Item.Kit_Type),
         Storage (12 .. 19));
      Marlowe.Key_Storage.To_Storage
         (Marlowe.Database_Index (Item.Reference), Storage (20 .. 27));
