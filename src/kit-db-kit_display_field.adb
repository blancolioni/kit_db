...
with Kit.Db.Kit_Display_Field_Cache;

package body Kit.Db.Kit_Display_Field is

   type Kit_Display_Field_Implementation is
        limited new Ada.Finalization.Limited_Controlled
     and Kit_Display_Field_Interface with
      record
         Finished        : Boolean;
         Forward         : Boolean;
         Read_Only       : Boolean;
         ...
         M_Index         : Kit_Display_Field_Reference;
         T1_Data         :
            Kit_Root_Record_Impl.Kit_Root_Record_Database_Record;
         T16_Data        :
            Kit_Display_Field_Impl.Kit_Display_Field_Database_Record;
      end record;
   overriding function Has_Element (Item : Kit_Display_Field_Implementation)
      return Boolean;
   overriding procedure X_Lock (Item : Kit_Display_Field_Implementation);
   overriding function Get_Kit_Root_Record_Reference (Item :
      Kit_Display_Field_Implementation) return Kit_Root_Record_Reference;
   overriding function Get_Kit_Display_Field_Reference (Item :
      Kit_Display_Field_Implementation) return Kit_Display_Field_Reference;
   overriding function Top_Record (Item : Kit_Display_Field_Implementation)
      return Record_Type;
   overriding function Kit_Record (Item : Kit_Display_Field_Implementation)
      return Kit_Record_Reference;
   overriding function Kit_Field (Item : Kit_Display_Field_Implementation)
      return Kit_Field_Reference;
   overriding function Identity (Item : Kit_Display_Field_Implementation)
      return String;
   overriding function Get
     (Item  : Kit_Display_Field_Implementation;
      Field : String)
   return String;
   ...
   overriding function Previous
     (Object   : Iterator;
      Position : Cursor)
   return Cursor;
   type Kit_Display_Field_Table_Notify_Record is
        new Kit.Notifier.Table_Notify_Interface with
      record
         Handler : Kit_Display_Field_Table_Notify_Handler;
      end record;
   overriding procedure Notify_Table_Change (Handle :
      Kit_Display_Field_Table_Notify_Record);
   type Kit_Display_Field_Notify_Record is
   ...
   overriding procedure Notify_Record_Change
     (Handle         : Kit_Display_Field_Notify_Record;
      Changed_Record : Marlowe.Database_Index);
   type Kit_Display_Field_Update_Implementation is
        limited new Kit_Display_Field_Implementation
     and Kit_Display_Field_Update_Interface
     and Record_Update_Interface with null record;
   overriding procedure Initialize (Item :
      in out Kit_Display_Field_Update_Implementation);
   overriding procedure Finalize (Item :
      in out Kit_Display_Field_Update_Implementation);
   overriding procedure Delete (Item :
      in out Kit_Display_Field_Update_Implementation);
   overriding procedure Set
     (Item  : in out Kit_Display_Field_Update_Implementation;
      Field : String;
      Value : String);
   ...
   function Create return Kit_Display_Field_Update is
      T1_Access : Kit_Root_Record_Cache.Cache_Access;
      T16_Access : Kit_Display_Field_Cache.Cache_Access;
   begin
      return Result : Kit_Display_Field_Update_Implementation do
         ...
         T1_Access.Db.Top_Record := R_Kit_Display_Field;
         T16_Access := new Kit_Display_Field_Cache.Cache_Record;
         Memory_Mutex.Unlock;
         Kit_Root_Record_Impl.File_Mutex.Lock;
         T16_Access.Db.Kit_Root_Record := Kit_Root_Record_Reference
            (Marlowe_Keys.Handle.Insert_Record (1));
         T1_Access.Initialise (1, Marlowe.Database_Index
            (T16_Access.Db.Kit_Root_Record));
         Kit.Cache.Insert (Kit.Cache.Cache_Entry (T1_Access));
         Kit_Root_Record_Impl.Write (Marlowe.Database_Index
            (T16_Access.Db.Kit_Root_Record), T1_Access.Db);
         T1_Access.X_Lock;
         Kit_Root_Record_Impl.File_Mutex.Unlock;
         Kit_Display_Field_Impl.File_Mutex.Lock;
         Result.M_Index := Kit_Display_Field_Reference
            (Marlowe_Keys.Handle.Insert_Record (16));
         T16_Access.Initialise (16, Marlowe.Database_Index (Result.M_Index));
         Kit.Cache.Insert (Kit.Cache.Cache_Entry (T16_Access));
         Kit_Display_Field_Impl.Write (Marlowe.Database_Index
            (Result.M_Index), T16_Access.Db);
         T16_Access.X_Lock;
         Kit_Display_Field_Impl.File_Mutex.Unlock;
         Result.T1_Data := T1_Access.Db;
         Result.T16_Data := T16_Access.Db;
         Result.Read_Only := False;
      end return;
   end Create;
   ...
   is
      Result : Kit_Display_Field_Update := Create;
   begin
      Result.Set_Kit_Record (Kit_Record);
      Result.Set_Kit_Field (Kit_Field);
      return Result.Get_Kit_Display_Field_Reference;
   end Create;
   ...
   overriding procedure Delete (Item :
      in out Kit_Display_Field_Update_Implementation) is
   begin
   ...
   function Element (Item : Cursor) return Kit_Display_Field_Reference is
   begin
   ...
   begin
      ...
      if Item.Deleted then
         ...
         & Marlowe.Key_Storage.To_Storage_Array (Marlowe.Database_Index
            (Item.T16_Data.Kit_Root_Record)));
         Marlowe_Keys.Handle.Delete (Marlowe_Keys.T16_Top_Record_Ref,
            Marlowe.Key_Storage.To_Storage_Array (Record_Type'Pos
            (Item.Top_Record), 4)
         & Marlowe.Key_Storage.To_Storage_Array (Marlowe.Database_Index
            (Item.M_Index)));
         Marlowe_Keys.Handle.Delete (Marlowe_Keys.T16_T1_Idx_Ref,
            Marlowe.Key_Storage.To_Storage_Array (Marlowe.Database_Index
            (Item.T16_Data.Kit_Root_Record))
         & Marlowe.Key_Storage.To_Storage_Array (Marlowe.Database_Index
            (Item.M_Index)));
         Marlowe_Keys.Handle.Delete (Marlowe_Keys.T16_Kit_Record_Ref,
            Marlowe.Key_Storage.To_Storage_Array (Marlowe.Database_Index
            (Item.Kit_Record))
         & Marlowe.Key_Storage.To_Storage_Array (Marlowe.Database_Index
            (Item.M_Index)));
         Marlowe_Keys.Handle.Delete (Marlowe_Keys.T16_Kit_Field_Ref,
            Marlowe.Key_Storage.To_Storage_Array (Marlowe.Database_Index
            (Item.Kit_Field))
         & Marlowe.Key_Storage.To_Storage_Array (Marlowe.Database_Index
            (Item.M_Index)));
         Item.T1_Data.Deleted := True;
         Item.T16_Data.Deleted := True;
         Kit.Notifier.Record_Deleted (1, Marlowe.Database_Index
            (Item.T16_Data.Kit_Root_Record));
         Kit.Notifier.Record_Deleted (16, Marlowe.Database_Index
            (Item.M_Index));
      end if;
      if not (Item.Read_Only or else Item.Created) or else Item.Deleted then
         Kit.Notifier.Record_Changed (1, Marlowe.Database_Index
            (Item.T16_Data.Kit_Root_Record));
         Kit.Notifier.Record_Changed (16, Marlowe.Database_Index
            (Item.M_Index));
      end if;
      if (not Item.Read_Only) and then Item.Created then
         ...
         & Marlowe.Key_Storage.To_Storage_Array (Marlowe.Database_Index
            (Item.T16_Data.Kit_Root_Record)));
         Marlowe_Keys.Handle.Insert (Marlowe_Keys.T16_Top_Record_Ref,
            Marlowe.Key_Storage.To_Storage_Array (Record_Type'Pos
            (Item.Top_Record), 4)
         & Marlowe.Key_Storage.To_Storage_Array (Marlowe.Database_Index
            (Item.M_Index)));
         Marlowe_Keys.Handle.Insert (Marlowe_Keys.T16_T1_Idx_Ref,
            Marlowe.Key_Storage.To_Storage_Array (Marlowe.Database_Index
            (Item.T16_Data.Kit_Root_Record))
         & Marlowe.Key_Storage.To_Storage_Array (Marlowe.Database_Index
            (Item.M_Index)));
         Marlowe_Keys.Handle.Insert (Marlowe_Keys.T16_Kit_Record_Ref,
            Marlowe.Key_Storage.To_Storage_Array (Marlowe.Database_Index
            (Item.Kit_Record))
         & Marlowe.Key_Storage.To_Storage_Array (Marlowe.Database_Index
            (Item.M_Index)));
         Marlowe_Keys.Handle.Insert (Marlowe_Keys.T16_Kit_Field_Ref,
            Marlowe.Key_Storage.To_Storage_Array (Marlowe.Database_Index
            (Item.Kit_Field))
         & Marlowe.Key_Storage.To_Storage_Array (Marlowe.Database_Index
            (Item.M_Index)));
         ...
         Kit.Notifier.Record_Created (1, Marlowe.Database_Index
            (Item.T16_Data.Kit_Root_Record));
         Kit.Notifier.Record_Created (16, Marlowe.Database_Index
            (Item.M_Index));
      end if;
      if not Item.Read_Only then
         ...
         declare
            T16_Access : constant Kit_Display_Field_Cache.Cache_Access :=
               Kit_Display_Field_Cache.Get (Marlowe.Database_Index
               (Item.M_Index));
         begin
            T16_Access.Db := Item.T16_Data;
         end;
      end if;
      if not Item.Read_Only then
         Kit_Root_Record_Cache.Unlock (Marlowe.Database_Index
            (Item.T16_Data.Kit_Root_Record));
         Kit_Display_Field_Cache.Unlock (Marlowe.Database_Index
            (Item.M_Index));
      end if;
      Item.M_Index := 0;
      Item.Created := False;
   ...
   function First_By_Kit_Field (Kit_Field : Kit_Field_Reference)
      return Kit_Display_Field_Reference is
      use type System.Storage_Elements.Storage_Array;
      Db_Index : Marlowe.Database_Index := 0;
   begin
      Kit_Deferred_Keys.Check_Keys (1);
      Kit_Deferred_Keys.Check_Keys (16);
      Kit_Display_Field_Impl.File_Mutex.Shared_Lock;
      declare
         M : constant Marlowe.Data_Stores.Data_Store_Cursor :=
            Marlowe_Keys.Handle.Search (Marlowe_Keys.T16_Kit_Field_Ref,
            Marlowe.Key_Storage.To_Storage_Array (Marlowe.Database_Index
      ...
      Kit_Display_Field_Impl.File_Mutex.Shared_Unlock;
      return Kit_Display_Field_Reference (Db_Index);
   ...
   begin
      ...
      declare
         M : constant Marlowe.Data_Stores.Data_Store_Cursor :=
            Marlowe_Keys.Handle.Search (Marlowe_Keys.T16_Kit_Record_Ref,
            Marlowe.Key_Storage.To_Storage_Array (Marlowe.Database_Index
   ...
   begin
      ...
      declare
         M : constant Marlowe.Data_Stores.Data_Store_Cursor :=
            Marlowe_Keys.Handle.Search (Marlowe_Keys.T16_Top_Record_Ref,
            Marlowe.Key_Storage.To_Storage_Array (Record_Type'Pos
   ...
   function Get (Ref : Kit_Display_Field_Reference)
      return Kit_Display_Field_Type is
   begin
      return Result : Kit_Display_Field_Implementation do
         Kit_Display_Field_Impl.File_Mutex.Shared_Lock;
         Result.M_Index := Ref;
         if Result.M_Index /= Null_Kit_Display_Field_Reference then
            Kit_Display_Field_Cache.S_Lock (Marlowe.Database_Index
               (Result.M_Index));
            Result.T16_Data := Kit_Display_Field_Cache.Get
               (Marlowe.Database_Index (Result.M_Index), False).Db;
            Kit_Root_Record_Cache.S_Lock (Marlowe.Database_Index
               (Result.T16_Data.Kit_Root_Record));
            Result.T1_Data := Kit_Root_Record_Cache.Get
               (Marlowe.Database_Index (Result.T16_Data.Kit_Root_Record),
               False).Db;
            Kit_Display_Field_Cache.Unlock (Marlowe.Database_Index
               (Result.M_Index));
            Kit_Root_Record_Cache.Unlock (Marlowe.Database_Index
   ...
   function Get_From_Kit_Root_Record (Kit_Root_Record :
      Kit_Root_Record_Reference) return Kit_Display_Field_Reference is
      use type System.Storage_Elements.Storage_Array;
      Db_Index : Marlowe.Database_Index := 0;
   begin
      Kit_Deferred_Keys.Check_Keys (1);
      ...
      declare
         M : constant Marlowe.Data_Stores.Data_Store_Cursor :=
            Marlowe_Keys.Handle.Search (Marlowe_Keys.T16_T1_Idx_Ref,
            Marlowe.Key_Storage.To_Storage_Array (Marlowe.Database_Index
   ...
   -------------------------------------
   -- Get_Kit_Display_Field_Reference --
   -------------------------------------
   ...
   overriding function Get_Kit_Root_Record_Reference (Item :
      Kit_Display_Field_Implementation) return Kit_Root_Record_Reference
   is (Item.T16_Data.Kit_Root_Record);
   ...
   function Get_Update (Ref : Kit_Display_Field_Reference)
      return Kit_Display_Field_Update is
   begin
      return Result : Kit_Display_Field_Update_Implementation do
         Kit_Display_Field_Impl.File_Mutex.Shared_Lock;
         Result.M_Index := Ref;
         if Result.M_Index /= Null_Kit_Display_Field_Reference then
            Kit_Display_Field_Cache.U_Lock (Marlowe.Database_Index
               (Result.M_Index));
            Result.T16_Data := Kit_Display_Field_Cache.Get
               (Marlowe.Database_Index (Result.M_Index), False).Db;
   ...
   overriding function Identity (Item : Kit_Display_Field_Implementation)
      return String is
   begin
      return "kit_display_field" & Kit_Display_Field_Reference'Image
         (Item.Get_Kit_Display_Field_Reference);
   end Identity;
   ...
   overriding function Kit_Field (Item : Kit_Display_Field_Implementation)
      ...
      Result : Kit_Field_Reference
        renames Item.T16_Data.Kit_Field;
   begin
      return Result;
   end Kit_Field;
   ...
   overriding function Kit_Record (Item : Kit_Display_Field_Implementation)
      ...
      Result : Kit_Record_Reference
        renames Item.T16_Data.Kit_Record;
   begin
      return Result;
   end Kit_Record;
   ...
   is
   begin
      Handle.Handler (Kit_Display_Field_Reference (Changed_Record));
   ...
   overriding procedure Notify_Table_Change (Handle :
      Kit_Display_Field_Table_Notify_Record) is
   begin
      Handle.Handler.all;
   end Notify_Table_Change;

   ---------------------------------
   -- On_Kit_Display_Field_Change --
   ---------------------------------
   ...
   procedure On_Kit_Display_Field_Change
     (Reference : Kit_Display_Field_Reference;
      Handler   : Kit_Display_Field_Notify_Handler)
   is
      Rec : Kit_Display_Field_Notify_Record;
   begin
      Rec.Handler := Handler;
      Kit.Notifier.Add_Record_Change_Handler
        (16,
         ...
         Rec);
   end On_Kit_Display_Field_Change;

   ----------------------------------
   -- On_Kit_Display_Field_Created --
   ----------------------------------

   procedure On_Kit_Display_Field_Created (Handler :
      Kit_Display_Field_Notify_Handler) is
      Rec : Kit_Display_Field_Notify_Record;
   begin
      Rec.Handler := Handler;
      Kit.Notifier.Add_Record_Create_Handler (16, Rec);
   end On_Kit_Display_Field_Created;

   ----------------------------------
   -- On_Kit_Display_Field_Deleted --
   ----------------------------------
   ...
   begin
      Rec.Handler := Handler;
      Kit.Notifier.Add_Record_Delete_Handler (16, Rec);
   end On_Kit_Display_Field_Deleted;

   ---------------------------------------
   -- On_Kit_Display_Field_Table_Change --
   ---------------------------------------

   procedure On_Kit_Display_Field_Table_Change (Handler :
      Kit_Display_Field_Table_Notify_Handler) is
      Rec : Kit_Display_Field_Table_Notify_Record;
   begin
      Rec.Handler := Handler;
      Kit.Notifier.Add_Table_Change_Handler (16, Rec);
   end On_Kit_Display_Field_Table_Change;
      ...
      begin
         return Result : Selection do
            while Mark.Valid loop
               Result.Elements.Append (Kit_Display_Field_Reference
   ...
   begin
      ...
      if not Item.Created then
         Kit_Deferred_Keys.Key_Changed
           (16,
            Marlowe_Keys.T16_Kit_Field_Ref,
   ...
   begin
      ...
      if not Item.Created then
         Kit_Deferred_Keys.Key_Changed
           (16,
            Marlowe_Keys.T16_Kit_Record_Ref,
            Marlowe.Database_Index (Item.M_Index),
            Marlowe.Key_Storage.To_Storage_Array (Marlowe.Database_Index
               (Item.Kit_Record)),
            Marlowe.Key_Storage.To_Storage_Array (Marlowe.Database_Index
   ...
   overriding procedure X_Lock (Item : Kit_Display_Field_Implementation) is
   begin
      Kit_Root_Record_Cache.X_Lock (Marlowe.Database_Index
         (Item.T16_Data.Kit_Root_Record));
      Kit_Display_Field_Cache.X_Lock (Marlowe.Database_Index (Item.M_Index));
   end X_Lock;
