...
package Kit.Db.Kit_Type is
   ...
   type Kit_Type_Interface is limited interface
     and Record_Interface
     and Search_Interface
     and Kit.Db.Kit_Root_Record.Kit_Root_Record_Interface;

   subtype Kit_Type_Type is Kit_Type_Interface'Class;

   function Get_Kit_Type_Reference (Item : Kit_Type_Interface)
      return Kit_Type_Reference
      is abstract;

   function Size (Item : Kit_Type_Interface) return Integer
      is abstract;

   function Name (Item : Kit_Type_Interface) return String
      is abstract;

   type Kit_Type_Update_Interface is limited interface
     and Kit_Type_Interface
     and Kit.Db.Kit_Root_Record.Kit_Root_Record_Update_Interface;

   subtype Kit_Type_Update is Kit_Type_Update_Interface'Class;
   function Create return Kit_Type_Update;
   procedure Create
     (Size : Integer;
      Name : String);
   function Create
   ...
   type Constant_Reference_Type
      (Element : not null access constant Kit_Type_Reference) is private
   with Implicit_Dereference => Element;
   type Reference_Type (Element : not null access Kit_Type_Type) is private
   with Implicit_Dereference => Element;
   ...
   with Constant_Indexing => Constant_Reference,
        ...
        Iterator_Element => Kit_Type_Reference;
   ...
   function Element (Item : Cursor) return Kit_Type_Reference;
   ...
   function Get_From_Kit_Root_Record (Kit_Root_Record :
      Kit_Root_Record_Reference) return Kit_Type_Reference;

   function Scan_By_Name return Selection;

   function Get_By_Name (Name : String) return Kit_Type_Reference;
   ...
   function Get (Ref : Kit_Type_Reference) return Kit_Type_Type;
   function Get_Update (Ref : Kit_Type_Reference) return Kit_Type_Update;
   ...
   type Kit_Type_Notify_Handler is access
     procedure (Reference : Kit_Type_Reference);
   type Kit_Type_Table_Notify_Handler is access
     procedure;

   procedure On_Kit_Type_Table_Change (Handler :
      Kit_Type_Table_Notify_Handler);
   procedure On_Kit_Type_Change
     (Reference : Kit_Type_Reference;
      Handler   : Kit_Type_Notify_Handler);
   procedure On_Kit_Type_Created (Handler : Kit_Type_Notify_Handler);
   procedure On_Kit_Type_Deleted (Handler : Kit_Type_Notify_Handler);
   procedure Set_Size
     (Item  : in out Kit_Type_Update_Interface;
      Value : Integer)
      is abstract;
...
private
   ...
   type Constant_Reference_Type
      (Element : not null access constant Kit_Type_Reference) is
       null record;
   type Reference_Type (Element : not null access Kit_Type_Type) is
          null record;
