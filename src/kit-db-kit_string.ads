...
package Kit.Db.Kit_String is
   ...
   type Kit_String_Interface is limited interface
   ...
   subtype Kit_String_Type is Kit_String_Interface'Class;

   function Get_Kit_String_Reference (Item : Kit_String_Interface)
      return Kit_String_Reference
      is abstract;

   function Length (Item : Kit_String_Interface) return Integer
      is abstract;

   type Kit_String_Update_Interface is limited interface
     and Kit_String_Interface
     and Kit.Db.Kit_Root_Record.Kit_Root_Record_Update_Interface
     and Kit.Db.Kit_Type.Kit_Type_Update_Interface;

   subtype Kit_String_Update is Kit_String_Update_Interface'Class;
   function Create return Kit_String_Update;
   procedure Create
     (Size   : Integer;
      Name   : String;
      Length : Integer);
   ...
   type Constant_Reference_Type
      (Element : not null access constant Kit_String_Reference) is private
   with Implicit_Dereference => Element;
   type Reference_Type (Element : not null access Kit_String_Type) is private
   with Implicit_Dereference => Element;
   ...
   with Constant_Indexing => Constant_Reference,
        ...
        Iterator_Element => Kit_String_Reference;
   ...
   function Element (Item : Cursor) return Kit_String_Reference;
   ...
   function Get_From_Kit_Root_Record (Kit_Root_Record :
      Kit_Root_Record_Reference) return Kit_String_Reference;

   function Scan_By_Name return Selection;

   function Get_By_Name (Name : String) return Kit_String_Reference;
   ...
   function Get (Ref : Kit_String_Reference) return Kit_String_Type;
   function Get_Update (Ref : Kit_String_Reference) return Kit_String_Update;
   ...
   type Kit_String_Notify_Handler is access
     procedure (Reference : Kit_String_Reference);
   type Kit_String_Table_Notify_Handler is access
     procedure;

   procedure On_Kit_String_Table_Change (Handler :
      Kit_String_Table_Notify_Handler);
   procedure On_Kit_String_Change
     (Reference : Kit_String_Reference;
      Handler   : Kit_String_Notify_Handler);
   procedure On_Kit_String_Created (Handler : Kit_String_Notify_Handler);
   procedure On_Kit_String_Deleted (Handler : Kit_String_Notify_Handler);
   procedure Set_Length
     (Item  : in out Kit_String_Update_Interface;
      Value : Integer)
      is abstract;
...
private
   ...
   package List_Of_References is
     new Ada.Containers.Doubly_Linked_Lists
          (Kit_String_Reference);
   type Cursor is
      record
         Current : List_Of_References.Cursor;
      end record;
   type Constant_Reference_Type
      (Element : not null access constant Kit_String_Reference) is
          null record;
   type Reference_Type (Element : not null access Kit_String_Type) is
          null record;
