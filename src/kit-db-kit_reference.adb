...
with Kit.Db.Kit_Reference_Cache;

package body Kit.Db.Kit_Reference is

   type Kit_Reference_Implementation is
        limited new Ada.Finalization.Limited_Controlled
     and Kit_Reference_Interface with
      record
         Finished        : Boolean;
         Forward         : Boolean;
         Read_Only       : Boolean;
         ...
         M_Index         : Kit_Reference_Reference;
         T1_Data         :
            Kit_Root_Record_Impl.Kit_Root_Record_Database_Record;
         T4_Data         : Kit_Type_Impl.Kit_Type_Database_Record;
         T9_Data         : Kit_Reference_Impl.Kit_Reference_Database_Record;
      end record;
   overriding function Has_Element (Item : Kit_Reference_Implementation)
      return Boolean;
   overriding procedure X_Lock (Item : Kit_Reference_Implementation);
   overriding function Get_Kit_Root_Record_Reference (Item :
      Kit_Reference_Implementation) return Kit_Root_Record_Reference;
   overriding function Get_Kit_Type_Reference (Item :
      Kit_Reference_Implementation) return Kit_Type_Reference;
   overriding function Get_Kit_Reference_Reference (Item :
      Kit_Reference_Implementation) return Kit_Reference_Reference;
   overriding function Top_Record (Item : Kit_Reference_Implementation)
      return Record_Type;
   overriding function Size (Item : Kit_Reference_Implementation)
      return Integer;
   overriding function Name (Item : Kit_Reference_Implementation)
      return String;
   overriding function Reference (Item : Kit_Reference_Implementation)
      return Kit_Record_Reference;
   overriding function Identity (Item : Kit_Reference_Implementation)
      return String;
   overriding function Get
     (Item  : Kit_Reference_Implementation;
      Field : String)
   return String;
   ...
   overriding function Previous
     (Object   : Iterator;
      Position : Cursor)
   return Cursor;
   type Kit_Reference_Table_Notify_Record is
        new Kit.Notifier.Table_Notify_Interface with
      record
         Handler : Kit_Reference_Table_Notify_Handler;
      end record;
   overriding procedure Notify_Table_Change (Handle :
      Kit_Reference_Table_Notify_Record);
   type Kit_Reference_Notify_Record is
   ...
   overriding procedure Notify_Record_Change
     (Handle         : Kit_Reference_Notify_Record;
      Changed_Record : Marlowe.Database_Index);
   type Kit_Reference_Update_Implementation is
        limited new Kit_Reference_Implementation
     and Kit_Reference_Update_Interface
     and Record_Update_Interface with null record;
   overriding procedure Initialize (Item :
      in out Kit_Reference_Update_Implementation);
   overriding procedure Finalize (Item :
      in out Kit_Reference_Update_Implementation);
   overriding procedure Delete (Item :
      in out Kit_Reference_Update_Implementation);
   overriding procedure Set
     (Item  : in out Kit_Reference_Update_Implementation;
      Field : String;
      Value : String);
   ...
   function Create return Kit_Reference_Update is
      T1_Access : Kit_Root_Record_Cache.Cache_Access;
      T4_Access : Kit_Type_Cache.Cache_Access;
      T9_Access : Kit_Reference_Cache.Cache_Access;
   begin
      return Result : Kit_Reference_Update_Implementation do
         ...
         T1_Access.Db.Top_Record := R_Kit_Reference;
         T4_Access := new Kit_Type_Cache.Cache_Record;
         T9_Access := new Kit_Reference_Cache.Cache_Record;
         Memory_Mutex.Unlock;
         Kit_Root_Record_Impl.File_Mutex.Lock;
         T9_Access.Db.Kit_Root_Record := Kit_Root_Record_Reference
            (Marlowe_Keys.Handle.Insert_Record (1));
         T1_Access.Initialise (1, Marlowe.Database_Index
            (T9_Access.Db.Kit_Root_Record));
         Kit.Cache.Insert (Kit.Cache.Cache_Entry (T1_Access));
         Kit_Root_Record_Impl.Write (Marlowe.Database_Index
            (T9_Access.Db.Kit_Root_Record), T1_Access.Db);
         T1_Access.X_Lock;
         Kit_Root_Record_Impl.File_Mutex.Unlock;
         Kit_Type_Impl.File_Mutex.Lock;
         T9_Access.Db.Kit_Type := Kit_Type_Reference
            (Marlowe_Keys.Handle.Insert_Record (4));
         T4_Access.Db.Kit_Root_Record := T9_Access.Db.Kit_Root_Record;
         T4_Access.Initialise (4, Marlowe.Database_Index
            (T9_Access.Db.Kit_Type));
         Kit.Cache.Insert (Kit.Cache.Cache_Entry (T4_Access));
         Kit_Type_Impl.Write (Marlowe.Database_Index (T9_Access.Db.Kit_Type),
            T4_Access.Db);
         T4_Access.X_Lock;
         Kit_Type_Impl.File_Mutex.Unlock;
         Kit_Reference_Impl.File_Mutex.Lock;
         Result.M_Index := Kit_Reference_Reference
            (Marlowe_Keys.Handle.Insert_Record (9));
         T9_Access.Initialise (9, Marlowe.Database_Index (Result.M_Index));
         Kit.Cache.Insert (Kit.Cache.Cache_Entry (T9_Access));
         Kit_Reference_Impl.Write (Marlowe.Database_Index (Result.M_Index),
            T9_Access.Db);
         T9_Access.X_Lock;
         Kit_Reference_Impl.File_Mutex.Unlock;
         Result.T1_Data := T1_Access.Db;
         Result.T4_Data := T4_Access.Db;
         Result.T9_Data := T9_Access.Db;
         Result.Read_Only := False;
      end return;
   end Create;
   ...
   is
      Result : Kit_Reference_Update := Create;
   begin
      Result.Set_Size (Size);
      Result.Set_Name (Name);
      Result.Set_Reference (Reference);
      return Result.Get_Kit_Reference_Reference;
   end Create;
   ...
   overriding procedure Delete (Item :
      in out Kit_Reference_Update_Implementation) is
   begin
   ...
   function Element (Item : Cursor) return Kit_Reference_Reference is
   begin
   ...
   begin
      ...
      if Item.Deleted then
         ...
         & Marlowe.Key_Storage.To_Storage_Array (Marlowe.Database_Index
            (Item.T9_Data.Kit_Type)));
         Marlowe_Keys.Handle.Delete (Marlowe_Keys.T9_Top_Record_Ref,
            Marlowe.Key_Storage.To_Storage_Array (Record_Type'Pos
            (Item.Top_Record), 4)
         & Marlowe.Key_Storage.To_Storage_Array (Marlowe.Database_Index
            (Item.M_Index)));
         Marlowe_Keys.Handle.Delete (Marlowe_Keys.T9_T1_Idx_Ref,
            Marlowe.Key_Storage.To_Storage_Array (Marlowe.Database_Index
            (Item.T9_Data.Kit_Root_Record))
         & Marlowe.Key_Storage.To_Storage_Array (Marlowe.Database_Index
            (Item.M_Index)));
         Marlowe_Keys.Handle.Delete (Marlowe_Keys.T9_Name_Ref,
            Marlowe.Key_Storage.To_Storage_Array (Item.Name, 64)
         & Marlowe.Key_Storage.To_Storage_Array (Marlowe.Database_Index
            (Item.M_Index)));
         Marlowe_Keys.Handle.Delete (Marlowe_Keys.T9_T4_Idx_Ref,
            Marlowe.Key_Storage.To_Storage_Array (Marlowe.Database_Index
            (Item.T9_Data.Kit_Type))
         & Marlowe.Key_Storage.To_Storage_Array (Marlowe.Database_Index
            (Item.M_Index)));
      ...
      if not (Item.Read_Only or else Item.Created) or else Item.Deleted then
         ...
         Kit.Notifier.Record_Changed (4, Marlowe.Database_Index
            (Item.T9_Data.Kit_Type));
         Kit.Notifier.Record_Changed (9, Marlowe.Database_Index
            (Item.M_Index));
      end if;
      if (not Item.Read_Only) and then Item.Created then
         ...
         & Marlowe.Key_Storage.To_Storage_Array (Marlowe.Database_Index
            (Item.T9_Data.Kit_Type)));
         Marlowe_Keys.Handle.Insert (Marlowe_Keys.T9_Top_Record_Ref,
            Marlowe.Key_Storage.To_Storage_Array (Record_Type'Pos
            (Item.Top_Record), 4)
         & Marlowe.Key_Storage.To_Storage_Array (Marlowe.Database_Index
            (Item.M_Index)));
         Marlowe_Keys.Handle.Insert (Marlowe_Keys.T9_T1_Idx_Ref,
            Marlowe.Key_Storage.To_Storage_Array (Marlowe.Database_Index
            (Item.T9_Data.Kit_Root_Record))
         & Marlowe.Key_Storage.To_Storage_Array (Marlowe.Database_Index
            (Item.M_Index)));
         Marlowe_Keys.Handle.Insert (Marlowe_Keys.T9_Name_Ref,
            Marlowe.Key_Storage.To_Storage_Array (Item.Name, 64)
         & Marlowe.Key_Storage.To_Storage_Array (Marlowe.Database_Index
            (Item.M_Index)));
         Marlowe_Keys.Handle.Insert (Marlowe_Keys.T9_T4_Idx_Ref,
            Marlowe.Key_Storage.To_Storage_Array (Marlowe.Database_Index
            (Item.T9_Data.Kit_Type))
         & Marlowe.Key_Storage.To_Storage_Array (Marlowe.Database_Index
            (Item.M_Index)));
         ...
         Kit.Notifier.Record_Created (4, Marlowe.Database_Index
            (Item.T9_Data.Kit_Type));
         Kit.Notifier.Record_Created (9, Marlowe.Database_Index
            (Item.M_Index));
      end if;
      if not Item.Read_Only then
         ...
         declare
            T9_Access : constant Kit_Reference_Cache.Cache_Access :=
               Kit_Reference_Cache.Get (Marlowe.Database_Index
               (Item.M_Index));
         begin
            T9_Access.Db := Item.T9_Data;
         end;
      end if;
      if not Item.Read_Only then
         ...
         Kit_Type_Cache.Unlock (Marlowe.Database_Index
            (Item.T9_Data.Kit_Type));
         Kit_Reference_Cache.Unlock (Marlowe.Database_Index (Item.M_Index));
      end if;
      Item.M_Index := 0;
      Item.Created := False;
   end Finalize;
   ...
   function First_By_Top_Record (Top_Record : Record_Type)
      return Kit_Reference_Reference is
      use type System.Storage_Elements.Storage_Array;
      Db_Index : Marlowe.Database_Index := 0;
   begin
      Kit_Deferred_Keys.Check_Keys (1);
      Kit_Reference_Impl.File_Mutex.Shared_Lock;
      declare
         M : constant Marlowe.Data_Stores.Data_Store_Cursor :=
            Marlowe_Keys.Handle.Search (Marlowe_Keys.T9_Top_Record_Ref,
            Marlowe.Key_Storage.To_Storage_Array (Record_Type'Pos
      ...
      Kit_Reference_Impl.File_Mutex.Shared_Unlock;
      return Kit_Reference_Reference (Db_Index);
   ...
   function Get (Ref : Kit_Reference_Reference) return Kit_Reference_Type is
   begin
      return Result : Kit_Reference_Implementation do
         Kit_Reference_Impl.File_Mutex.Shared_Lock;
         Result.M_Index := Ref;
         if Result.M_Index /= Null_Kit_Reference_Reference then
            Kit_Reference_Cache.S_Lock (Marlowe.Database_Index
               (Result.M_Index));
            Result.T9_Data := Kit_Reference_Cache.Get (Marlowe.Database_Index
               (Result.M_Index), False).Db;
            Kit_Type_Cache.S_Lock (Marlowe.Database_Index
               (Result.T9_Data.Kit_Type));
            Result.T4_Data := Kit_Type_Cache.Get (Marlowe.Database_Index
               (Result.T9_Data.Kit_Type), False).Db;
            Kit_Root_Record_Cache.S_Lock (Marlowe.Database_Index
               (Result.T9_Data.Kit_Root_Record));
            Result.T1_Data := Kit_Root_Record_Cache.Get
               (Marlowe.Database_Index (Result.T9_Data.Kit_Root_Record),
               False).Db;
            Kit_Reference_Cache.Unlock (Marlowe.Database_Index
               (Result.M_Index));
            Kit_Type_Cache.Unlock (Marlowe.Database_Index
               (Result.T9_Data.Kit_Type));
            Kit_Root_Record_Cache.Unlock (Marlowe.Database_Index
   ...
   begin
      ...
      elsif Field = "reference" then
         return Kit_Record_Reference'Image (Item.Reference);
      else
         raise Constraint_Error with
           "no such field";
      end if;
   ...
   function Get_By_Name (Name : String) return Kit_Reference_Reference is
      use type System.Storage_Elements.Storage_Array;
      Db_Index : Marlowe.Database_Index := 0;
   begin
      Kit_Deferred_Keys.Check_Keys (1);
      ...
      declare
         M : constant Marlowe.Data_Stores.Data_Store_Cursor :=
            Marlowe_Keys.Handle.Search (Marlowe_Keys.T9_Name_Ref,
   ...
   function Get_From_Kit_Root_Record (Kit_Root_Record :
      Kit_Root_Record_Reference) return Kit_Reference_Reference is
      use type System.Storage_Elements.Storage_Array;
      Db_Index : Marlowe.Database_Index := 0;
   begin
      Kit_Deferred_Keys.Check_Keys (1);
      ...
      declare
         M : constant Marlowe.Data_Stores.Data_Store_Cursor :=
            Marlowe_Keys.Handle.Search (Marlowe_Keys.T9_T1_Idx_Ref,
            Marlowe.Key_Storage.To_Storage_Array (Marlowe.Database_Index
   ...
   begin
      Kit_Deferred_Keys.Check_Keys (1);
      Kit_Deferred_Keys.Check_Keys (4);
      Kit_Deferred_Keys.Check_Keys (9);
      Kit_Reference_Impl.File_Mutex.Shared_Lock;
      declare
         M : constant Marlowe.Data_Stores.Data_Store_Cursor :=
            Marlowe_Keys.Handle.Search (Marlowe_Keys.T9_T4_Idx_Ref,
            Marlowe.Key_Storage.To_Storage_Array (Marlowe.Database_Index
   ...
   overriding function Get_Kit_Root_Record_Reference (Item :
      Kit_Reference_Implementation) return Kit_Root_Record_Reference
   is (Item.T9_Data.Kit_Root_Record);
   ...
   function Get_Update (Ref : Kit_Reference_Reference)
      return Kit_Reference_Update is
   begin
      return Result : Kit_Reference_Update_Implementation do
         Kit_Reference_Impl.File_Mutex.Shared_Lock;
         Result.M_Index := Ref;
         if Result.M_Index /= Null_Kit_Reference_Reference then
            Kit_Reference_Cache.U_Lock (Marlowe.Database_Index
               (Result.M_Index));
            Result.T9_Data := Kit_Reference_Cache.Get (Marlowe.Database_Index
               (Result.M_Index), False).Db;
   ...
   overriding function Identity (Item : Kit_Reference_Implementation)
      return String is
   begin
      return "kit_reference" & Kit_Reference_Reference'Image
         (Item.Get_Kit_Reference_Reference);
   end Identity;
   ...
   is
   begin
      Handle.Handler (Kit_Reference_Reference (Changed_Record));
   ...
   overriding procedure Notify_Table_Change (Handle :
      Kit_Reference_Table_Notify_Record) is
   begin
      Handle.Handler.all;
   end Notify_Table_Change;

   -----------------------------
   -- On_Kit_Reference_Change --
   -----------------------------
   ...
   procedure On_Kit_Reference_Change
     (Reference : Kit_Reference_Reference;
      Handler   : Kit_Reference_Notify_Handler)
   is
      Rec : Kit_Reference_Notify_Record;
   begin
      Rec.Handler := Handler;
      Kit.Notifier.Add_Record_Change_Handler
        (9,
         ...
         Rec);
   end On_Kit_Reference_Change;

   ------------------------------
   -- On_Kit_Reference_Created --
   ------------------------------

   procedure On_Kit_Reference_Created (Handler :
      Kit_Reference_Notify_Handler) is
      Rec : Kit_Reference_Notify_Record;
   begin
      Rec.Handler := Handler;
      Kit.Notifier.Add_Record_Create_Handler (9, Rec);
   end On_Kit_Reference_Created;

   ------------------------------
   -- On_Kit_Reference_Deleted --
   ------------------------------
   ...
   begin
      Rec.Handler := Handler;
      Kit.Notifier.Add_Record_Delete_Handler (9, Rec);
   end On_Kit_Reference_Deleted;

   -----------------------------------
   -- On_Kit_Reference_Table_Change --
   -----------------------------------

   procedure On_Kit_Reference_Table_Change (Handler :
      Kit_Reference_Table_Notify_Handler) is
      Rec : Kit_Reference_Table_Notify_Record;
   begin
      Rec.Handler := Handler;
      Kit.Notifier.Add_Table_Change_Handler (9, Rec);
   end On_Kit_Reference_Table_Change;
   ...
   overriding function Reference (Item : Kit_Reference_Implementation)
      ...
      Result : Kit_Record_Reference
        renames Item.T9_Data.Reference;
   begin
      return Result;
   end Reference;
   ...
   begin
      ...
      declare
         ...
         Mark : Marlowe.Data_Stores.Data_Store_Cursor :=
            Marlowe_Keys.Handle.Search (Marlowe_Keys.T9_Name_Ref, First_Key,
            Last_Key, Marlowe.Closed, Marlowe.Closed, Marlowe.Forward);
      begin
         return Result : Selection do
            while Mark.Valid loop
               Result.Elements.Append (Kit_Reference_Reference
   ...
   begin
      if Field = "" then
         ...
         Item.Set_Reference (Kit_Record_Reference'Value (Value));
      else
         raise Constraint_Error with
           "no such field";
      end if;
      ...
      if not Item.Created then
         Kit_Deferred_Keys.Key_Changed
           (4,
            ...
            Marlowe.Database_Index (Item.T9_Data.Kit_Type),
            Marlowe.Key_Storage.To_Storage_Array (Item.Name, 64),
   ...
   is
   begin
      Item.Set_Reference (Value.Get_Kit_Record_Reference);
   end Set_Reference;
   ...
   overriding procedure X_Lock (Item : Kit_Reference_Implementation) is
   begin
      Kit_Root_Record_Cache.X_Lock (Marlowe.Database_Index
         (Item.T9_Data.Kit_Root_Record));
      Kit_Type_Cache.X_Lock (Marlowe.Database_Index (Item.T9_Data.Kit_Type));
      Kit_Reference_Cache.X_Lock (Marlowe.Database_Index (Item.M_Index));
   end X_Lock;
