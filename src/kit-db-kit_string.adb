...
package body Kit.Db.Kit_String is

   type Kit_String_Implementation is
        limited new Ada.Finalization.Limited_Controlled
     and Kit_String_Interface with
      record
         Finished        : Boolean;
         Forward         : Boolean;
         Read_Only       : Boolean;
   ...
   overriding function Has_Element (Item : Kit_String_Implementation)
      return Boolean;
   overriding procedure X_Lock (Item : Kit_String_Implementation);
   overriding function Get_Kit_Root_Record_Reference (Item :
      Kit_String_Implementation) return Kit_Root_Record_Reference;
   overriding function Get_Kit_Type_Reference (Item :
      Kit_String_Implementation) return Kit_Type_Reference;
   overriding function Get_Kit_String_Reference (Item :
      Kit_String_Implementation) return Kit_String_Reference;
   overriding function Top_Record (Item : Kit_String_Implementation)
      return Record_Type;
   overriding function Size (Item : Kit_String_Implementation)
      return Integer;
   overriding function Name (Item : Kit_String_Implementation) return String;
   overriding function Length (Item : Kit_String_Implementation)
      return Integer;
   overriding function Identity (Item : Kit_String_Implementation)
      return String;
   overriding function Get
     (Item  : Kit_String_Implementation;
      Field : String)
   return String;
   ...
   overriding function Previous
     (Object   : Iterator;
      Position : Cursor)
   return Cursor;
   type Kit_String_Table_Notify_Record is
        new Kit.Notifier.Table_Notify_Interface with
      record
         Handler : Kit_String_Table_Notify_Handler;
      end record;
   overriding procedure Notify_Table_Change (Handle :
      Kit_String_Table_Notify_Record);
   type Kit_String_Notify_Record is
        new Kit.Notifier.Record_Notify_Interface with
      record
         Handler : Kit_String_Notify_Handler;
      end record;
   overriding procedure Notify_Record_Change
     (Handle         : Kit_String_Notify_Record;
      Changed_Record : Marlowe.Database_Index);
   type Kit_String_Update_Implementation is
        limited new Kit_String_Implementation
     and Kit_String_Update_Interface
     and Record_Update_Interface with null record;
   overriding procedure Initialize (Item :
      in out Kit_String_Update_Implementation);
   overriding procedure Finalize (Item :
      in out Kit_String_Update_Implementation);
   overriding procedure Delete (Item :
      in out Kit_String_Update_Implementation);
   overriding procedure Set
     (Item  : in out Kit_String_Update_Implementation;
      Field : String;
      Value : String);
   ...
   procedure Create
     (Size   : Integer;
      ...
      Length : Integer)
   is
      Result : Kit_String_Update := Create;
   begin
   ...
   begin
      ...
      Result.Set_Name (Name);
      Result.Set_Length (Length);
      return Result.Get_Kit_String_Reference;
   end Create;
   ...
   function Create return Kit_String_Update is
   ...
   begin
      return Result : Kit_String_Update_Implementation do
         ...
         T1_Access.Db.Top_Record := R_Kit_String;
   ...
   overriding procedure Delete (Item :
      in out Kit_String_Update_Implementation) is
   begin
   ...
   function Element (Item : Cursor) return Kit_String_Reference is
   begin
   ...
   begin
      ...
      if not Item.Read_Only then
         ...
         declare
            T10_Access : constant Kit_String_Cache.Cache_Access :=
               Kit_String_Cache.Get (Marlowe.Database_Index (Item.M_Index));
         begin
      ...
      if not Item.Read_Only then
         ...
         Kit_Type_Cache.Unlock (Marlowe.Database_Index
            (Item.T10_Data.Kit_Type));
         Kit_String_Cache.Unlock (Marlowe.Database_Index (Item.M_Index));
      end if;
      Item.M_Index := 0;
      Item.Created := False;
   end Finalize;
   ...
   function First_By_Top_Record (Top_Record : Record_Type)
      return Kit_String_Reference is
      use type System.Storage_Elements.Storage_Array;
      Db_Index : Marlowe.Database_Index := 0;
   begin
      Kit_Deferred_Keys.Check_Keys (1);
      Kit_String_Impl.File_Mutex.Shared_Lock;
      declare
         M : constant Marlowe.Data_Stores.Data_Store_Cursor :=
            Marlowe_Keys.Handle.Search (Marlowe_Keys.T10_Top_Record_Ref,
            Marlowe.Key_Storage.To_Storage_Array (Record_Type'Pos
      ...
      Kit_String_Impl.File_Mutex.Shared_Unlock;
      return Kit_String_Reference (Db_Index);
   ...
   function Get (Ref : Kit_String_Reference) return Kit_String_Type is
   begin
      return Result : Kit_String_Implementation do
         Kit_String_Impl.File_Mutex.Shared_Lock;
         Result.M_Index := Ref;
         if Result.M_Index /= Null_Kit_String_Reference then
   ...
   function Get_By_Name (Name : String) return Kit_String_Reference is
      use type System.Storage_Elements.Storage_Array;
      Db_Index : Marlowe.Database_Index := 0;
   begin
      Kit_Deferred_Keys.Check_Keys (1);
      ...
      declare
         M : constant Marlowe.Data_Stores.Data_Store_Cursor :=
            Marlowe_Keys.Handle.Search (Marlowe_Keys.T10_Name_Ref,
   ...
   function Get_From_Kit_Root_Record (Kit_Root_Record :
      Kit_Root_Record_Reference) return Kit_String_Reference is
      use type System.Storage_Elements.Storage_Array;
      Db_Index : Marlowe.Database_Index := 0;
   begin
      Kit_Deferred_Keys.Check_Keys (1);
      ...
      declare
         M : constant Marlowe.Data_Stores.Data_Store_Cursor :=
            Marlowe_Keys.Handle.Search (Marlowe_Keys.T10_T1_Idx_Ref,
            Marlowe.Key_Storage.To_Storage_Array (Marlowe.Database_Index
   ...
   begin
      ...
      declare
         M : constant Marlowe.Data_Stores.Data_Store_Cursor :=
            Marlowe_Keys.Handle.Search (Marlowe_Keys.T10_T4_Idx_Ref,
            Marlowe.Key_Storage.To_Storage_Array (Marlowe.Database_Index
   ...
   overriding function Get_Kit_Root_Record_Reference (Item :
      Kit_String_Implementation) return Kit_Root_Record_Reference
   is (Item.T10_Data.Kit_Root_Record);
   ...
   overriding function Get_Kit_Type_Reference (Item :
      Kit_String_Implementation) return Kit_Type_Reference
   is (Item.T10_Data.Kit_Type);

   ----------------
   -- Get_Update --
   ----------------

   function Get_Update (Ref : Kit_String_Reference)
      return Kit_String_Update is
   begin
      return Result : Kit_String_Update_Implementation do
         Kit_String_Impl.File_Mutex.Shared_Lock;
         Result.M_Index := Ref;
   ...
   overriding function Identity (Item : Kit_String_Implementation)
      return String is
   begin
      return "kit_string" & Kit_String_Reference'Image
         (Item.Get_Kit_String_Reference);
   end Identity;
   ...
   overriding function Name (Item : Kit_String_Implementation)
      return String is
   ...
   is
   begin
      Handle.Handler (Kit_String_Reference (Changed_Record));
   ...
   overriding procedure Notify_Table_Change (Handle :
      Kit_String_Table_Notify_Record) is
   begin
      Handle.Handler.all;
   end Notify_Table_Change;

   --------------------------
   -- On_Kit_String_Change --
   --------------------------

   procedure On_Kit_String_Change
     (Reference : Kit_String_Reference;
      Handler   : Kit_String_Notify_Handler)
   is
      Rec : Kit_String_Notify_Record;
   begin
      Rec.Handler := Handler;
      Kit.Notifier.Add_Record_Change_Handler
        (10,
         ...
         Rec);
   end On_Kit_String_Change;

   ---------------------------
   -- On_Kit_String_Created --
   ---------------------------

   procedure On_Kit_String_Created (Handler : Kit_String_Notify_Handler) is
      Rec : Kit_String_Notify_Record;
   begin
      Rec.Handler := Handler;
      Kit.Notifier.Add_Record_Create_Handler (10, Rec);
   end On_Kit_String_Created;

   ---------------------------
   -- On_Kit_String_Deleted --
   ---------------------------

   procedure On_Kit_String_Deleted (Handler : Kit_String_Notify_Handler) is
      Rec : Kit_String_Notify_Record;
   begin
      Rec.Handler := Handler;
      Kit.Notifier.Add_Record_Delete_Handler (10, Rec);
   end On_Kit_String_Deleted;

   --------------------------------
   -- On_Kit_String_Table_Change --
   --------------------------------

   procedure On_Kit_String_Table_Change (Handler :
      Kit_String_Table_Notify_Handler) is
      Rec : Kit_String_Table_Notify_Record;
   begin
      Rec.Handler := Handler;
      Kit.Notifier.Add_Table_Change_Handler (10, Rec);
   end On_Kit_String_Table_Change;
   ...
   begin
      ...
      declare
         ...
         Mark : Marlowe.Data_Stores.Data_Store_Cursor :=
            Marlowe_Keys.Handle.Search (Marlowe_Keys.T10_Name_Ref, First_Key,
            Last_Key, Marlowe.Closed, Marlowe.Closed, Marlowe.Forward);
      begin
         return Result : Selection do
            while Mark.Valid loop
               Result.Elements.Append (Kit_String_Reference
      ...
      if not Item.Created then
         Kit_Deferred_Keys.Key_Changed
           (4,
            ...
            Marlowe.Database_Index (Item.T10_Data.Kit_Type),
            Marlowe.Key_Storage.To_Storage_Array (Item.Name, 64),
   ...
   overriding procedure X_Lock (Item : Kit_String_Implementation) is
   begin
      Kit_Root_Record_Cache.X_Lock (Marlowe.Database_Index
         (Item.T10_Data.Kit_Root_Record));
      Kit_Type_Cache.X_Lock (Marlowe.Database_Index
         (Item.T10_Data.Kit_Type));
      Kit_String_Cache.X_Lock (Marlowe.Database_Index (Item.M_Index));
   end X_Lock;

end Kit.Db.Kit_String;
