...
package body Kit.Db.Kit_Long_Integer_Impl is
   ...
   begin
      return Kit_Long_Integer_Database_Record'Size / System.Storage_Unit;
   ...
   is
      Storage : System.Storage_Elements.Storage_Array (0 .. 35);
   begin
      Marlowe_Keys.Handle.Get_Record
        (Kit_Long_Integer_Table_Index,
         Ref,
         Storage'Address);
      declare
      ...
      Integer_64_Storage.From_Storage (Item.Low, Storage (20 .. 27));
      Integer_64_Storage.From_Storage (Item.High, Storage (28 .. 35));
   end Read;
   ...
   begin
      ...
      Marlowe.Key_Storage.To_Storage (Marlowe.Database_Index (Item.Kit_Type),
         Storage (12 .. 19));
      Integer_64_Storage.To_Storage (Item.Low, Storage (20 .. 27));
      Integer_64_Storage.To_Storage (Item.High, Storage (28 .. 35));
