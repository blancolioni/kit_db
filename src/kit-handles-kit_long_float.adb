...
with Kit.Db.Kit_Long_Float_Hashes;

package body Kit.Handles.Kit_Long_Float is
   ...
   package Cached_Handle_Maps is
     new Kit.Protected_Maps
          (Kit.Db.Kit_Long_Float_Reference,
         Cached_Handle,
         Load,
         Kit.Db.Kit_Long_Float_Hashes.Hash,
         Db."=");
   ...
   type Iterator is
      ...
      record
         Container : access Kit_Long_Float_Selection;
      end record;
   ...
   is
   begin
      return Get (Kit.Db.Kit_Long_Float.Element (Position.Db));
   ...
   is
   begin
      return Get (Kit.Db.Kit_Long_Float.Create (Size, Name));
   end Create;
   ...
   procedure Create
     (Size : Integer;
      Name : String)
   is
      Handle : constant Kit_Long_Float_Handle := Create (Size, Name);
   ...
   procedure Done (Update : Kit_Long_Float_Update_Handle) is
      Rec : Kit.Db.Kit_Long_Float.Kit_Long_Float_Update :=
         Kit.Db.Kit_Long_Float.Get_Update (Update.Reference);
   begin
   ...
   function Element (Item : Cursor) return Kit_Long_Float_Class is
   begin
      return Get (Kit.Db.Kit_Long_Float.Element (Item.Db));
   end Element;
   ...
   function Empty_Handle return Kit_Long_Float_Handle is
   begin
      return Get (Kit.Db.Null_Kit_Long_Float_Reference);
   end Empty_Handle;
   ...
   begin
      return Position : Cursor do
         Position.Db := Kit.Db.Kit_Long_Float.First (It.Container.Db);
      end return;
   end First;
   ...
   function First_By_Top_Record (Top_Record : Kit.Db.Record_Type)
      return Kit_Long_Float_Handle is
      use Kit.Db;
      Ref : constant Kit_Long_Float_Reference :=
         Kit.Db.Kit_Long_Float.First_By_Top_Record (Top_Record);
      Result : Kit_Long_Float_Handle;
   begin
      if Ref /= Null_Kit_Long_Float_Reference then
         Result := Get (Ref);
      end if;
      return Result;
   ...
   function Get (Reference : Kit.Db.Kit_Long_Float_Reference)
      return Kit_Long_Float_Handle is
   begin
      return Handle : Kit_Long_Float_Handle do
   ...
   function Get_By_Name (Name : String) return Kit_Long_Float_Handle is
      use Kit.Db;
      Ref : constant Kit_Long_Float_Reference :=
         Kit.Db.Kit_Long_Float.Get_By_Name (Name);
      Result : Kit_Long_Float_Handle;
   begin
      if Ref /= Null_Kit_Long_Float_Reference then
         Result := Get (Ref);
   ...
   function Get_From_Kit_Root_Record (Kit_Root_Record :
      ...
      use Kit.Db;
      Ref : constant Kit_Long_Float_Reference :=
         Kit.Db.Kit_Long_Float.Get_From_Kit_Root_Record
   ...
   function Get_From_Kit_Type (Kit_Type :
      Kit.Handles.Kit_Type.Kit_Type_Class) return Kit_Long_Float_Handle is
      use Kit.Db;
      Ref : constant Kit_Long_Float_Reference :=
         Kit.Db.Kit_Long_Float.Get_From_Kit_Type
   ...
   begin
      return Kit.Db.Kit_Long_Float.Has_Element (Item.Db);
   end Has_Element;
   ...
   overriding function Has_Element (Handle : Kit_Long_Float_Handle)
      return Boolean is
      use type Kit.Db.Kit_Long_Float_Reference;
   begin
      return Handle.Reference /= Kit.Db.Null_Kit_Long_Float_Reference;
   end Has_Element;
   ...
   function Is_Empty (Container : Kit_Long_Float_Selection) return Boolean is
   begin
      return Kit.Db.Kit_Long_Float.Is_Empty (Container.Db);
   end Is_Empty;
   ...
   function Kit_Root_Record_Handle (Handle : Kit_Long_Float_Handle)
      ...
      Rec : constant Kit.Db.Kit_Long_Float.Kit_Long_Float_Type :=
         Kit.Db.Kit_Long_Float.Get (Handle.Reference);
   begin
   ...
   begin
      return Position : Cursor do
         Position.Db := Kit.Db.Kit_Long_Float.Last (It.Container.Db);
      end return;
   end Last;
   ...
   function Last_By_Top_Record (Top_Record : Kit.Db.Record_Type)
      ...
      use Kit.Db;
      Ref : constant Kit_Long_Float_Reference :=
         Kit.Db.Kit_Long_Float.Last_By_Top_Record (Top_Record);
      Result : Kit_Long_Float_Handle;
   begin
      if Ref /= Null_Kit_Long_Float_Reference then
         Result := Get (Ref);
   ...
   function Length (Container : Kit_Long_Float_Selection) return Natural is
   begin
      return Kit.Db.Kit_Long_Float.Length (Container.Db);
   end Length;
   ...
   is
      Rec : constant Kit.Db.Kit_Long_Float.Kit_Long_Float_Type :=
         Kit.Db.Kit_Long_Float.Get (Reference);
   begin
   ...
   overriding function Name (Handle : Kit_Long_Float_Handle) return String is
   ...
   begin
      return Result : Cursor do
         Result.Db := Kit.Db.Kit_Long_Float.Next (Position.Db);
      end return;
   end Next;
   ...
   begin
      return Result : Cursor do
         Result.Db := Kit.Db.Kit_Long_Float.Previous (Position.Db);
      end return;
   end Previous;
   ...
   function Reference (Handle : Kit_Long_Float_Handle)
      return Kit.Db.Kit_Long_Float_Reference is
   begin
      return Handle.Reference;
   end Reference;

   ------------------------------
   -- Reference_Kit_Long_Float --
   ------------------------------

   overriding function Reference_Kit_Long_Float (Handle :
      Kit_Long_Float_Handle) return Kit.Db.Kit_Long_Float_Reference is
   begin
      return Handle.Reference;
   end Reference_Kit_Long_Float;
   ...
   overriding function Reference_Kit_Root_Record (Handle :
      Kit_Long_Float_Handle) return Kit.Db.Kit_Root_Record_Reference is
      Rec : constant Constant_Reference_Type := Cache.Constant_Reference
         (Handle.Reference);
   begin
   ...
   function Scan_By_Name return Kit_Long_Float_Selection is
      Db_Selection : constant Kit.Db.Kit_Long_Float.Selection :=
         Kit.Db.Kit_Long_Float.Scan_By_Name;
   begin
   ...
   function Scan_By_Top_Record return Kit_Long_Float_Selection is
      Db_Selection : constant Kit.Db.Kit_Long_Float.Selection :=
         Kit.Db.Kit_Long_Float.Scan_By_Top_Record;
   begin
      return (Db => Db_Selection);
   ...
   is
      Db_Selection : constant Kit.Db.Kit_Long_Float.Selection :=
         Kit.Db.Kit_Long_Float.Select_Bounded_By_Name (Start_Name,
         Finish_Name);
   begin
      return (Db => Db_Selection);
   ...
   is
      Db_Selection : constant Kit.Db.Kit_Long_Float.Selection :=
         Kit.Db.Kit_Long_Float.Select_Bounded_By_Top_Record
   ...
   function Select_By_Name (Name : String) return Kit_Long_Float_Selection is
      Db_Selection : constant Kit.Db.Kit_Long_Float.Selection :=
         Kit.Db.Kit_Long_Float.Select_By_Name (Name);
   begin
      return (Db => Db_Selection);
   end Select_By_Name;
   ...
   function Select_By_Top_Record (Top_Record : Kit.Db.Record_Type)
      return Kit_Long_Float_Selection is
      Db_Selection : constant Kit.Db.Kit_Long_Float.Selection :=
         Kit.Db.Kit_Long_Float.Select_By_Top_Record (Top_Record);
   begin
      return (Db => Db_Selection);
   ...
   is
      Change : Kit_Long_Float_Update_Value (Update_Name);
   begin
      Change.Name_Value.Length := Value'Length;
      Change.Name_Value.Text (1 .. Value'Length) := Value;
      return Result : Kit_Long_Float_Update_Handle do
   ...
   return Kit_Long_Float_Update_Handle
   is
      Change : Kit_Long_Float_Update_Value (Update_Size);
   begin
   ...
   overriding function Size (Handle : Kit_Long_Float_Handle)
      return Integer is
      Rec : constant Constant_Reference_Type := Cache.Constant_Reference
         (Handle.Reference);
   begin
   ...
   ------------------------------
   -- To_Kit_Long_Float_Handle --
   ------------------------------

   function To_Kit_Long_Float_Handle (Class : Kit_Long_Float_Class)
      return Kit_Long_Float_Handle is
   begin
      return Get (Class.Reference_Kit_Long_Float);
   end To_Kit_Long_Float_Handle;
   ...
   function Update (Handle : Kit_Long_Float_Handle)
      return Kit_Long_Float_Update_Handle'Class is
   begin
      return Update_Kit_Long_Float (Handle.Reference);
   end Update;

   ---------------------------
   -- Update_Kit_Long_Float --
   ---------------------------

   function Update_Kit_Long_Float (Target : Kit.Db.Kit_Long_Float_Reference)
      return Kit_Long_Float_Update_Handle is
   begin
      return Update : Kit_Long_Float_Update_Handle do
         Update.Reference := Target;
      end return;
   end Update_Kit_Long_Float;
