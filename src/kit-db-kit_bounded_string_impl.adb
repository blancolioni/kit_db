...
package body Kit.Db.Kit_Bounded_String_Impl is
   ...
   begin
      return Kit_Bounded_String_Database_Record'Size / System.Storage_Unit;
   ...
   begin
      Marlowe_Keys.Handle.Get_Record
        (Kit_Bounded_String_Table_Index,
         Ref,
         Storage'Address);
      declare
      ...
      begin
         ...
         Item.Kit_String := Kit_String_Reference (T);
      end;
   end Read;
   ...
   begin
      ...
      Marlowe.Key_Storage.To_Storage (Marlowe.Database_Index (Item.Kit_Type),
         Storage (12 .. 19));
      Marlowe.Key_Storage.To_Storage
         (Marlowe.Database_Index (Item.Kit_String), Storage (20 .. 27));
