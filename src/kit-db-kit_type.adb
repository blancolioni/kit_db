...
package body Kit.Db.Kit_Type is

   type Kit_Type_Implementation is
        limited new Ada.Finalization.Limited_Controlled
     and Kit_Type_Interface with
      record
         Finished        : Boolean;
         Forward         : Boolean;
         Read_Only       : Boolean;
         ...
         M_Index         : Kit_Type_Reference;
         T1_Data         :
            Kit_Root_Record_Impl.Kit_Root_Record_Database_Record;
         T4_Data         : Kit_Type_Impl.Kit_Type_Database_Record;
      end record;
   overriding function Has_Element (Item : Kit_Type_Implementation)
      return Boolean;
   overriding procedure X_Lock (Item : Kit_Type_Implementation);
   overriding function Get_Kit_Root_Record_Reference (Item :
      Kit_Type_Implementation) return Kit_Root_Record_Reference;
   overriding function Get_Kit_Type_Reference (Item :
      Kit_Type_Implementation) return Kit_Type_Reference;
   overriding function Top_Record (Item : Kit_Type_Implementation)
      return Record_Type;
   overriding function Size (Item : Kit_Type_Implementation) return Integer;
   overriding function Name (Item : Kit_Type_Implementation) return String;
   overriding function Identity (Item : Kit_Type_Implementation)
      return String;
   overriding function Get
     (Item  : Kit_Type_Implementation;
      Field : String)
   return String;
   ...
   overriding function Previous
     (Object   : Iterator;
      Position : Cursor)
   return Cursor;
   type Kit_Type_Table_Notify_Record is
        new Kit.Notifier.Table_Notify_Interface with
      record
         Handler : Kit_Type_Table_Notify_Handler;
      end record;
   overriding procedure Notify_Table_Change (Handle :
      Kit_Type_Table_Notify_Record);
   type Kit_Type_Notify_Record is
        new Kit.Notifier.Record_Notify_Interface with
      record
         Handler : Kit_Type_Notify_Handler;
      end record;
   overriding procedure Notify_Record_Change
     (Handle         : Kit_Type_Notify_Record;
      Changed_Record : Marlowe.Database_Index);
   type Kit_Type_Update_Implementation is limited new Kit_Type_Implementation
     and Kit_Type_Update_Interface
     and Record_Update_Interface with null record;
   overriding procedure Initialize (Item :
      in out Kit_Type_Update_Implementation);
   overriding procedure Finalize (Item :
      in out Kit_Type_Update_Implementation);
   overriding procedure Delete (Item : in out Kit_Type_Update_Implementation)
     ;
   overriding procedure Set
     (Item  : in out Kit_Type_Update_Implementation;
      Field : String;
      Value : String);
   ...
   is
      Result : Kit_Type_Update := Create;
   begin
      Result.Set_Size (Size);
      Result.Set_Name (Name);
      return Result.Get_Kit_Type_Reference;
   end Create;
   ...
   function Create return Kit_Type_Update is
      T1_Access : Kit_Root_Record_Cache.Cache_Access;
      T4_Access : Kit_Type_Cache.Cache_Access;
   begin
      return Result : Kit_Type_Update_Implementation do
   ...
   function Element (Item : Cursor) return Kit_Type_Reference is
   begin
   ...
   overriding procedure Finalize (Item :
      in out Kit_Type_Update_Implementation) is
   ...
   begin
      ...
      if not Item.Read_Only then
         ...
         declare
            T4_Access : constant Kit_Type_Cache.Cache_Access :=
               Kit_Type_Cache.Get (Marlowe.Database_Index (Item.M_Index));
         begin
      ...
      if not Item.Read_Only then
         Kit_Root_Record_Cache.Unlock (Marlowe.Database_Index
            (Item.T4_Data.Kit_Root_Record));
         Kit_Type_Cache.Unlock (Marlowe.Database_Index (Item.M_Index));
      end if;
      Item.M_Index := 0;
      Item.Created := False;
   end Finalize;
   ...
   begin
      ...
      Kit_Type_Impl.File_Mutex.Shared_Lock;
      declare
         M : constant Marlowe.Data_Stores.Data_Store_Cursor :=
            Marlowe_Keys.Handle.Search (Marlowe_Keys.T4_Top_Record_Ref,
            Marlowe.Key_Storage.To_Storage_Array (Record_Type'Pos
      ...
      Kit_Type_Impl.File_Mutex.Shared_Unlock;
      return Kit_Type_Reference (Db_Index);
   ...
   function Get (Ref : Kit_Type_Reference) return Kit_Type_Type is
   begin
      return Result : Kit_Type_Implementation do
         Kit_Type_Impl.File_Mutex.Shared_Lock;
         Result.M_Index := Ref;
         if Result.M_Index /= Null_Kit_Type_Reference then
            Kit_Type_Cache.S_Lock (Marlowe.Database_Index (Result.M_Index));
            ...
            Kit_Root_Record_Cache.S_Lock (Marlowe.Database_Index
               (Result.T4_Data.Kit_Root_Record));
            Result.T1_Data := Kit_Root_Record_Cache.Get
               (Marlowe.Database_Index (Result.T4_Data.Kit_Root_Record),
               False).Db;
            Kit_Type_Cache.Unlock (Marlowe.Database_Index (Result.M_Index));
            Kit_Root_Record_Cache.Unlock (Marlowe.Database_Index
               (Result.T4_Data.Kit_Root_Record));
         end if;
         Result.Finished := False;
   ...
   function Get_By_Name (Name : String) return Kit_Type_Reference is
      use type System.Storage_Elements.Storage_Array;
      Db_Index : Marlowe.Database_Index := 0;
   begin
      Kit_Deferred_Keys.Check_Keys (1);
      ...
      declare
         M : constant Marlowe.Data_Stores.Data_Store_Cursor :=
            Marlowe_Keys.Handle.Search (Marlowe_Keys.T4_Name_Ref,
   ...
   function Get_From_Kit_Root_Record (Kit_Root_Record :
      Kit_Root_Record_Reference) return Kit_Type_Reference is
      use type System.Storage_Elements.Storage_Array;
      Db_Index : Marlowe.Database_Index := 0;
   begin
      Kit_Deferred_Keys.Check_Keys (1);
      ...
      declare
         M : constant Marlowe.Data_Stores.Data_Store_Cursor :=
            Marlowe_Keys.Handle.Search (Marlowe_Keys.T4_T1_Idx_Ref,
            Marlowe.Key_Storage.To_Storage_Array (Marlowe.Database_Index
   ...
   overriding function Get_Kit_Root_Record_Reference (Item :
      Kit_Type_Implementation) return Kit_Root_Record_Reference
   is (Item.T4_Data.Kit_Root_Record);
   ...
   function Get_Update (Ref : Kit_Type_Reference) return Kit_Type_Update is
   begin
      return Result : Kit_Type_Update_Implementation do
         Kit_Type_Impl.File_Mutex.Shared_Lock;
         Result.M_Index := Ref;
         if Result.M_Index /= Null_Kit_Type_Reference then
            Kit_Type_Cache.U_Lock (Marlowe.Database_Index (Result.M_Index));
            Result.T4_Data := Kit_Type_Cache.Get (Marlowe.Database_Index
               (Result.M_Index), False).Db;
   ...
   overriding function Identity (Item : Kit_Type_Implementation)
      return String is
   begin
      return "kit_type" & Kit_Type_Reference'Image
         (Item.Get_Kit_Type_Reference);
   end Identity;
   ...
   begin
      return Get_By_Name (Name) /= Null_Kit_Type_Reference;
   end Is_Name;
   ...
   overriding function Name (Item : Kit_Type_Implementation) return String is
   ...
   is
   begin
      Handle.Handler (Kit_Type_Reference (Changed_Record));
   ...
   overriding procedure Notify_Table_Change (Handle :
      Kit_Type_Table_Notify_Record) is
   begin
      Handle.Handler.all;
   ...
   procedure On_Kit_Type_Change
     (Reference : Kit_Type_Reference;
      Handler   : Kit_Type_Notify_Handler)
   is
      Rec : Kit_Type_Notify_Record;
   begin
      Rec.Handler := Handler;
      Kit.Notifier.Add_Record_Change_Handler
        (4,
         ...
         Rec);
   end On_Kit_Type_Change;

   -------------------------
   -- On_Kit_Type_Created --
   -------------------------

   procedure On_Kit_Type_Created (Handler : Kit_Type_Notify_Handler) is
      Rec : Kit_Type_Notify_Record;
   begin
      Rec.Handler := Handler;
      Kit.Notifier.Add_Record_Create_Handler (4, Rec);
   end On_Kit_Type_Created;

   -------------------------
   -- On_Kit_Type_Deleted --
   -------------------------

   procedure On_Kit_Type_Deleted (Handler : Kit_Type_Notify_Handler) is
      Rec : Kit_Type_Notify_Record;
   begin
      Rec.Handler := Handler;
      Kit.Notifier.Add_Record_Delete_Handler (4, Rec);
   end On_Kit_Type_Deleted;

   ------------------------------
   -- On_Kit_Type_Table_Change --
   ------------------------------

   procedure On_Kit_Type_Table_Change (Handler :
      Kit_Type_Table_Notify_Handler) is
      Rec : Kit_Type_Table_Notify_Record;
   begin
      Rec.Handler := Handler;
      Kit.Notifier.Add_Table_Change_Handler (4, Rec);
   end On_Kit_Type_Table_Change;
   ...
   begin
      ...
      declare
         ...
         Mark : Marlowe.Data_Stores.Data_Store_Cursor :=
            Marlowe_Keys.Handle.Search (Marlowe_Keys.T4_Name_Ref, First_Key,
            Last_Key, Marlowe.Closed, Marlowe.Closed, Marlowe.Forward);
      begin
         return Result : Selection do
            while Mark.Valid loop
               Result.Elements.Append (Kit_Type_Reference
   ...
   overriding function Size (Item : Kit_Type_Implementation)
      return Integer is
      Result : Integer
        renames Item.T4_Data.Size;
   begin
   ...
   overriding procedure X_Lock (Item : Kit_Type_Implementation) is
   begin
      Kit_Root_Record_Cache.X_Lock (Marlowe.Database_Index
         (Item.T4_Data.Kit_Root_Record));
      Kit_Type_Cache.X_Lock (Marlowe.Database_Index (Item.M_Index));
   end X_Lock;
