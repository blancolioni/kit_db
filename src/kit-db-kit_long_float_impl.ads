...
private package Kit.Db.Kit_Long_Float_Impl is

   Kit_Long_Float_Magic : constant  := 2002356665;

   type Kit_Long_Float_Database_Record is
      record
         Magic           : Integer := Kit_Long_Float_Magic;
   ...
   procedure Read
     (Ref  : Marlowe.Database_Index;
      Item :    out Kit_Long_Float_Database_Record);
   procedure Write
     (Ref  : Marlowe.Database_Index;
      Item : Kit_Long_Float_Database_Record);
...
end Kit.Db.Kit_Long_Float_Impl;
